...
(function($) {
   ...
   $(window).on('load', function() {
   		 ...
   		 $.getJSON("https://api.ethplorer.io/getTokenInfo/0x2129687ad072c0d040d2d5FF8331B036c8da8bdB?apiKey=freekey", function(result){
            
                $("h3#totalIn.stat-count").html(result.totalIn/10);
           		$("h3#totalOut.stat-count").html(result.totalOut/10);
                $("h3#hold.stat-count").html(result.holdersCount);
        });
